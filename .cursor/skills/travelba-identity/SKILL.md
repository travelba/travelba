...
- **Un passeport par personne** (titulaire ou compagnon), pas un passeport « du dossier » générique. Un PDF / une photo avec **plusieurs passeports** (couple, pages) → extraire **chaque** personne, rattacher au titulaire / compagnon existant, sinon **créer** le compagnon.
